...
GLQuad::GLQuad()
{
	...
	vertices[0] = VertexPC(glm::vec3(0, 0, 0), glm::vec4(1, 0, 0, 1));
	vertices[1] = VertexPC(glm::vec3(0, 1, 0), glm::vec4(0, 1, 0, 1));
	vertices[2] = VertexPC(glm::vec3(1, 1, 0), glm::vec4(0, 0, 1, 1));
	vertices[3] = VertexPC(glm::vec3(1, 0, 0), glm::vec4(1, 1, 0, 1));
...
//////////////////////////////////////////////////////////////////////////////////////////
GLQuad::GLQuad(const glm::vec4& color)
{
	// vertex data
	//
	//  1--2		  (0,0)----(1,0)
	...
	vertices[0] = VertexPC(glm::vec3(0, 0, 0), color);
	vertices[1] = VertexPC(glm::vec3(0, 1, 0), color);
	vertices[2] = VertexPC(glm::vec3(1, 1, 0), color);
	vertices[3] = VertexPC(glm::vec3(1, 0, 0), color);
...
void GLQuad::Update(float dt)
{
	...
	matProj = glm::perspectiveFov(45.0f, (float)gWindowWidth, (float)gWindowHeight, 0.1f, 1000.0f);
}
