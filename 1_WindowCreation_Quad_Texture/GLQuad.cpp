...
void GLQuad::Init()
{
	...
	m_pShader = new GLSLShader("Shaders/vsTextureQuad.glsl", "Shaders/psTextureQuad.glsl");
	...
	glVertexAttribPointer(posAttrib, 3, GL_FLOAT, false, sizeof(VertexPT), (void*)0);

	texAttrib = glGetAttribLocation(shader, "in_Texcoord");
	glEnableVertexAttribArray(texAttrib);
	glVertexAttribPointer(texAttrib, 2, GL_FLOAT, false, sizeof(VertexPT), (void*)offsetof(VertexPT, texcoord));
